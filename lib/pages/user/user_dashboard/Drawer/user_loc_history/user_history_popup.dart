...
class UserHistoryPopup extends StatefulWidget {
  @override
  State<UserHistoryPopup> createState() => _UserHistoryPopupState();
}

class _UserHistoryPopupState extends State<UserHistoryPopup> {
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('   You scanned at...', style: TextStyle(fontSize: 32)),
                      ...
                      InkWell(
                        child: Text(
                          ...
                          style: TextStyle(color: const Color.fromARGB(255, 125, 127, 128) ),
                        ),
                      ),
                    ],
                  ),
