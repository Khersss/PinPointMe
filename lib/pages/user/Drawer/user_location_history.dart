...
class UserLocationHistory extends StatefulWidget {
  @override
  _UserLocationHistoryState createState() => _UserLocationHistoryState();
}

class _UserLocationHistoryState extends State<UserLocationHistory> {
                ...
                return GestureDetector(
                  ...
                  onTap: () {
                    if (_isSelectionMode) {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => UserHistoryPopup()),
                      );
                    }
                  },
                  child: Card(
